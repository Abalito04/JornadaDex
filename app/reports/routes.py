...
def export_csv():
    ...
    writer.writerow(["Empleado", "Cliente", "Fecha", "Inicio", "Fin", "Horas", "Estado", "Area", "Tarea", "Observaciones"])
...
def export_excel():
    ...
    ws.append(["Empleado", "Cliente", "Fecha", "Inicio", "Fin", "Horas", "Estado", "Area", "Tarea", "Observaciones"])
    for record in records:
